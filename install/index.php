                        ...
                        <div id="wizard" class="aiia-wizard">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
												...
												<h4>Write user id :  anything</h4>
                                                    <input type="text" class="form-control" id="userid" name="userid" value="<?php echo @$_GET['userid'] ?>" placeholder="Nullcave.club" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
												<h4>Write Key :  Nullcave.club</h4>
                                                    <input type="password" class="form-control" id="purchase_key" value="<?php echo @$_GET['purchase_key'] ?>"  name="purchase_key"  placeholder="Nullcave.club" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="aiia-wizard-step <?php echo (isset($_GET['step3'])?'active':'') ?>">
                                ...
                                <div class="step-content step-three">
                                        ...
                                        <div class="form-group">
                                            <p class="text-info"><b> N.B:</b> Hostname should be <b>localhost</b> or <b>127.0.0.1</b></p>
                                        </div>
