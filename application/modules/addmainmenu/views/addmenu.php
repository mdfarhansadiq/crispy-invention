    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row" id="">
                    <div class="col-sm-6">
                        <form action="<?php echo site_url('addmainmenu/Addmenu/create'); ?>" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary">
                                <a href="<?php echo site_url('addmenu/edit/' . $menu->id); ?>" style="color: #ffffff">Edit</a></button> |
                            <button class="btn btn-danger"> <a href="<?php echo site_url('addmenu/delete/' . $menu->id); ?>" style="color: #ffffff;" onclick="return confirm('Are you sure you want to delete this menu?');">Delete</a></button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
