        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 pl-0">
                        <input name="num_of_room" autocomplete="off" class="form-control"  type="text" placeholder="<?php echo display('num_of_room') ?>" id="num_of_roomedit" value="<?php echo html_escape((!empty($intinfo->noofroom)?$intinfo->noofroom:null)) ?>">
                    </div>
                </div>
                ...
                <div class="form-group row" id="roomnoedit">
                    ...
                    <div class="col-sm-8 row allrom">
                        <?php for($i=1;$i<=$intinfo->noofroom;$i++){
                                                        if($i<10){
                                                            $i="0".$i;
                                                            }
                                                        else{
                        ...
                        ?>
                        <div class="col-sm-4 pl-0"><input name="room_no[]" autocomplete="off" class="form-control padding_m_bottom" type="text" id="room_no" value="<?php echo html_escape($intinfo->floorName.$i);?>"></div>
                        <?php } ?>
                    </div>
                </div>
