            ...
            <li class="nav-item dropdown quick-actions">
                ...
                <div class="dropdown-menu">
                    <div class="nav-grid-row row">
                        ...
                        <a href="<?php echo base_url('room_reservation/room_reservation') ?>" class="icon-menu-item col-4">
            ...
            <li class="nav-item dropdown user-menu">
                ...
                <div class="dropdown-menu">
                    ...
                    <div class="user-header">
                        ...
                        ?>
                        <div class="img-user">
                            <img src="<?php echo html_escape(base_url((!empty($image) ? $image : 'assets/img/user-icon.png'))) ?>" alt="">
                        </div><!-- img-user -->
                        <h6><?php echo html_escape($fullname) ?></h6>
                    </div><!-- user-header -->
                    <a href="<?php echo base_url('profile') ?>" class="dropdown-item"><i class="typcn typcn-user-outline"></i> <?php echo display('profile') ?></a>
                    <a href="<?php echo base_url('profile-setting') ?>" class="dropdown-item"><i class="typcn typcn-cog-outline"></i> <?php echo display('edit_profile') ?></a>
                    <a href="<?php echo base_url('logout') ?>" class="dropdown-item"><i class="typcn typcn-key-outline"></i> <?php echo display('logout') ?></a>
                </div>
                <!--/.dropdown-menu -->
            </li>
        </ul>
