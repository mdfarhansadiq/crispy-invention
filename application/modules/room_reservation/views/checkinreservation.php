                                            ...
                                            <td class="border-0">
                                                <div class="form-group mb-0">
                                                    <label class="font-weight-600 mb-1"><?php echo display('room_no') ?>
                                                        <span class="text-danger">*</span></label>
                                                    <div class="icon-addon addon-md input-left-icon">
                                                        <select name=room_name[] class="selectpicker form-select"
                                                            data-live-search="true" data-width="100%"
                                                            onchange="getcapcitys(<?php echo $r; ?>)" disabled
                                                            id="room_name<?php echo $r; ?>">
                                                            <option value="" selected>Choose
                                                                <?php echo display('room_no') ?></option>
                                                            <option value="<?php echo html_escape($room_name[$r+1]);?>"
                                                                selected><?php echo html_escape($room_name[$r+1]);?>
                                                            </option>
                                                        </select>
