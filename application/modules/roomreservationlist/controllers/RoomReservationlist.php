...
class RoomReservationlist extends MX_Controller
{
  ...
  public function __construct()
  {
    ...
    $this->load->model('roomreservationlist/Room_reservation_list_model', 'Room_reservation_list_model');
  }

  public function index()
  {
    $data['title'] = display('Room Reservation List');
    $data['module'] = "roomreservationlist";
    $data['page']   = "roomreservationlist";
    $data['customerbookinginfos'] = $this->Room_reservation_list_model->get_booking_info();
